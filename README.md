# EntraID_Automation_Suite
PowerShell scripts to automate Entra ID user lifecycle — bulk user creation, license assignment, Conditional Access, and inactive user management
